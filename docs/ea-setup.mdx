...
当前EA具备的条件是
1、4、7、10是间隔3递增很好的适应了震荡行情；10以上是1.5倍递增，尽量缩短`closeallorders()`的时间周期，避免大量订单累积造成爆仓。
...
- $10以上使用的是20的固定手数跟，止盈止损均为1300
  ...
  当上面两种情况同时出现的时候 当天的亏损就非常大。
      - 题外话：如果MD中出现`<1300` 符号跟数字，一定要用` `` `包起来，以免无法编译报错
...
| 止盈1800 | -180    | 0    | 180   | 360   | 540   | 900   | 1080  | 1260  | 1440 | 1620 | 1800 |
| -------- | ------- | ---- | ----- | ----- | ----- | ----- | ----- | ----- | ---- | ---- | ---- |
| 1800     | -230040 | 0    | 61560 | 59040 | 34560 | 32400 | 14040 | 12600 | 5760 | 6480 | 5400 |

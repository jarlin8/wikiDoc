---
title: "如何查看某位客户是否注册在了我名下"
description: "借助EXNESS的“客户代理分配查询”功能，现在您可以非常轻松地查看客户是否注册在了您的名下。如何查看"
---
...
![1. 登录您的个人专区](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-2246-ZH.gif)
*1. 登录您的**个人专区**。*
2. 点击右上角的姓名。
3. 选择**客户代理分配查询**。

...
| ------ |---| ------------ | ------ | ---- | ---- |
| 200 |---|4   | 200    | --- | --- |
| -400 |[-2400] | **5**    | -400   | 0-400-2000=-2400      | 1*1000 |
...
- [ 5-10 ]止损比不止损 多亏 4000 `止损适合夜间行情 21:00-03:00`

```
- 1-4 正常带止损6$ 不限时间跟单
- 5-10 正向10倍1$剥头皮止损1.2$[针对10 防止最后一笔单子无限亏损] 对冲止损 ❌过于理想的设定
- 5-100 反向10倍 0.75$剥头皮 5-10部分对冲正向头皮 10-100 赚取趋势利润
```
`不止损 适合白天行情 06:00-20:30`
- [ 1-4 ] 不带止损跟单 [5-100]反向10倍0.75$剥头皮  大行情需要人工值守 🎯[**或者干脆限定时间**]
---
title: EXNESS客户帮助
description: "保障您的vps安全 保证金和可用保证金之间有何区别 标准账户 标准账户和美分账户有什么不同 标准账户和先锋账户有什么不同 标准账户上可以交易哪些品种 不同类型的交易账户可以使用相同的服务器么 不同类型的账户是否有地区限制 不同账户类型的最大和最小交易手数是多少 部分退款请求 查询已归档订单"
---

...
title: "如何生成网络日志排除故障"
date: "2026-07-31"
description: "MT4/MT5 出现连接或下单异常时，如何生成网络日志并提交给 Exness 客服排查。含分步操作与日志文件的存放位置。"
---
...
![谷歌浏览器](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-3160_ZH.gif)
...
![火狐浏览器 （Firefox）](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-3162-ZH.gif)
...
![IE 浏览器 （Internet Explorer）](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/ZH_CSVP-3165.gif)
...
![Safari 浏览器](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-3169_ZH.gif)

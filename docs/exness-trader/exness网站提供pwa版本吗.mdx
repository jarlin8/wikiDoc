...
date: "2023-01-10"
description: "是的，Exness网站也可以作为渐进式网络应用程序（PWA），供使用移动设备登录Exness个人专区（PA）的安卓用户使用。"
---
...
![CSVP 4323 All Language](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-4323-All_Language.png)
...
![客户会看到什么通知？](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-4324-ZH.png)

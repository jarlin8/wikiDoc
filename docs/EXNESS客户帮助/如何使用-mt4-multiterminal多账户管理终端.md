...
- 按可用保证金比例：平台会根据各账户的可用保证金比例将交易总量分配到各账户上。 计算方式和上述“按净值比例”的计算方式相似，只是在“按可用保证金比例”分配方式中我们计算的是每个账户的可用保证金。 例：在下表中，我们计划开立 3 手交易，系统会根据各账户可用保证金的比例将 1,804 美元分配到 3 个账户上。
...
现在您已经明白如何为各账户分配交易手数了，接下来我们来学习如何下交易订单。

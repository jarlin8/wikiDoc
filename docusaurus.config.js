...
const config = {
  scripts: [
    {src: 'https://www.matching-box.com/Scripts/quickBox.js', async: true, 'data-domain': 'www.matching-box.com'},
    {src: 'https://niu.fendou.la/wikiPrevBox/wikiPreviewBox.min.js', async: true, 'data-domain': 'niu.fendou.la'}
  ], 

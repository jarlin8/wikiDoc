...
date: "2023-01-10"
description: "了解相关信息的方法非常简单，让EXNESS带您了解应该如何操作。查看个人专区页面的页脚。进入个人资料 > 法律文件。您可以在此查看客户协议。查看页面页眉处即可了解您注册账户的 Exness 实体的名称。"
---
...
![Exness 交易应用（手机端应用）用户：](https://cdn.jsdelivr.net/gh/jarlin8/OSS@main/exhelp/CSVP-3443_ET_Entity_ZH_01.gif)

...
const Ads = () => {
  return (
    ...
    >
      <ul>
        <li><strong><span style={{ fontSize: '16px' }}>🎈<span style={{ backgroundColor: '#fefefe' }}><a href="https://www.ifttt.fun/go/atfx-cn" target="_blank" rel="noopener">ATFX开户</a></span>🎈</span>做外汇黄金原油，FCA监管，高流动性无滑点！</strong></li>
